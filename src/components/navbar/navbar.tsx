...
function navbar() {
  ...
  return (
    <div className="top-0 left-0 w-full fixed  z-30 backdrop-blur-sm h-16 bg-transparent text-white">
      <div className="relative px-10 py-4 mx-auto h-full transition-all ">
        <div className="  flex justify-between items-center h-full">

          <Link href={"/"}>
            <p className="text-xl font-semibold  ">Ikram Dadoune <span className="ml-1"> |</span></p>
          </Link>
        ...
        <div className="hidden md:flex justify-center items-center">
              <Link href="/CV.pdf" target="_blank">
                <button className="flex items-center  py-2 px-6  hover:bg-[#63A9FC] hover:text-white">
                  Resume
                  <svg
                    className="ml-2 "
                    width={21}
